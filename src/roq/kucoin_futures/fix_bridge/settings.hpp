...
template <>
struct fmt::formatter<roq::kucoin_futures::fix_bridge::Settings> {
  constexpr auto parse(format_parse_context &context) { return std::begin(context); }
  auto format(roq::kucoin_futures::fix_bridge::Settings const &value, format_context &context) const {
